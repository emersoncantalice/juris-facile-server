...
describe('Service Tests', () => {
    ...
    describe('DisciplinaJurisfacile Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DisciplinaJurisfacileService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/disciplinas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DisciplinaJurisfacile', () => {
