...
describe('Service Tests', () => {
    ...
    describe('TermoJurisfacile Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TermoJurisfacileService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/termos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TermoJurisfacile', () => {
