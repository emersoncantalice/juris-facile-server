...
describe('Service Tests', () => {
    ...
    describe('CursoJurisfacile Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CursoJurisfacileService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cursos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CursoJurisfacile', () => {
